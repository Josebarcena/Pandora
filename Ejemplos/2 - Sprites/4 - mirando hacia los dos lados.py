...
class Jugador(pygame.sprite.Sprite):
    ...
    def dibujar(self, pantalla):
        ...
        # En este caso, ya se pasa directamente la subimagen de la hoja del sprite
        if self.mirando == IZQUIERDA:
            pantalla.blit(self.hoja.subsurface(self.coordenadasHoja[self.numPostura][self.numImagenPostura]), (self.posicionx, self.posiciony))
        elif self.mirando == DERECHA:
            pantalla.blit(pygame.transform.flip(self.hoja.subsurface(self.coordenadasHoja[self.numPostura][self.numImagenPostura]),
                                                1, 0), (self.posicionx, self.posiciony))
